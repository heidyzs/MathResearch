...
mixture.25 <- read.csv("./Mixture/mixture_bootstrap_n.pop25_trial100_v2.csv")
mixture.10 <- read.csv("./Mixture/mixture_bootstrap_n.pop10_trial100_v2.csv")
```
...
```{r}
combined_muprior <- read.csv("./Mixture/mixture_bootstrap_mean70_changing_muprior.csv")
